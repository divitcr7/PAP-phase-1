    ...
    <Link to={`/property/${property.propertyId}`}>
      <div className="relative">
        <div className="absolute -top-3 left-4 z-20">
          <Badge className="bg-blue-600/90 text-white font-semibold px-3 py-1 text-sm shadow-lg">
          ...
          <div className="relative w-full h-52 md:h-64 overflow-hidden">
            <div className="absolute bottom-0 left-0 right-0 z-10 p-4 bg-gradient-to-t from-black/80 via-black/40 to-transparent">
              <div className="flex items-center justify-between">
                <Badge className="bg-blue-500/90 backdrop-blur-sm text-white dark:bg-blue-600/90 flex items-center gap-1">
                ...
                {property.currentPeriod && (
                  ...
                  >
                    Available from{" "}
                    {format(
                      new Date(property.currentPeriod.end),
                      "MMM d, yyyy"
                    )}
                  </Badge>
                )}
          ...
          <CardContent className="">
            <div className="space-y-4">
              ...
              {property.managementTeam &&
                property.managementTeam.length > 0 && (
